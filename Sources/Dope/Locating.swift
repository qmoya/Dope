...
//
	...
	//    }
//
	//    public subscript<Case, V>(dynamicMember keyPath: CaseKeyPath<V, Case>) -> Case? where V:
	//    CasePathable {
//
	//    }
...
private func update(in value: Value, locator: Locator, newValue: some Any) -> Value {
...
extension Value {
	init(newValue: some Any, for locator: Locator) {
		switch locator {
		case .number:
